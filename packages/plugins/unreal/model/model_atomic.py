# Generated unreal implementation for model atomic tools
...
def getMeshs(ids: List[str]) -> Dict[str, Any]:
    ...
    Returns:
    success (bool): Operation success status
    items (List[Dict[str, Any] with keys {"id": str, "name": str, "metadata": Dict[str, Any], "position": List[float], "rotation": List[float], "scale": List[float], "parentId": str, "childIds": List[str], "vertices": List[List[float]], "edges": List[List[int]], "faces": List[int]}]): Array of Meshs objects
    """
...
def createCurves(items: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    Args:
    items (List[Dict[str, Any] with keys {"name": str, "metadata": Dict[str, Any], "position": List[float], "rotation": List[float], "scale": List[float], "parentId": str, "childIds": List[str], "degree": int, "controlPoints": List[Dict[str, Any] with keys {"position": List[float], "weight": float}], "knots": List[float], "closed": bool}]): Array of Curves to create
...
def updateCurves(items: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    Args:
    items (List[Dict[str, Any] with keys {"ids": List[str], "name": str, "metadata": Dict[str, Any], "position": List[float], "rotation": List[float], "scale": List[float], "parentId": str, "childIds": List[str], "degree": int, "controlPoints": List[Dict[str, Any] with keys {"position": List[float], "weight": float}], "knots": List[float], "closed": bool}]): Array of Curves to update with their IDs
...
def listCurves(parentId: Optional[str] = None, filters: Optional[Dict[str, Any]] = None, limit: Optional[int] = None, offset: Optional[int] = None) -> Dict[str, Any]:
    ...
    Returns:
    success (bool): Operation success status
    items (List[Dict[str, Any] with keys {"id": str, "name": str, "metadata": Dict[str, Any], "position": List[float], "rotation": List[float], "scale": List[float], "parentId": str, "childIds": List[str], "degree": int, "controlPoints": List[Dict[str, Any] with keys {"position": List[float], "weight": float}], "knots": List[float], "closed": bool}]): Array of Curves objects
...
def createMeshs(items: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    Args:
    items (List[Dict[str, Any] with keys {"name": str, "metadata": Dict[str, Any], "position": List[float], "rotation": List[float], "scale": List[float], "parentId": str, "childIds": List[str], "vertices": List[List[float]], "edges": List[List[int]], "faces": List[int]}]): Array of Meshs to create
...
def updateMeshs(items: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    Args:
    items (List[Dict[str, Any] with keys {"ids": List[str], "name": str, "metadata": Dict[str, Any], "position": List[float], "rotation": List[float], "scale": List[float], "parentId": str, "childIds": List[str], "vertices": List[List[float]], "edges": List[List[int]], "faces": List[int]}]): Array of Meshs to update with their IDs
...
def addSubsurfModifierLevel(level: int) -> Dict[str, Any]:
    ...
    params = {"level": level}  # Create params dict for logging
    unreal.log("Executing {0} in Unreal Engine", tool_name)
...
def bevel(amount: float, type: Literal["vertex", "edge"]) -> Dict[str, Any]:
    ...
    type (Literal["vertex", "edge"]): The type parameter
    ...
    try:
        ...
        # Validate enum values for type
        if type is not None and type not in ['vertex','edge']:
            raise ValueError(f"Parameter 'type' must be one of ['vertex','edge'], got {type}")
...
def subdivide(count: float) -> Dict[str, Any]:

    """
    Subdivide selected edges or faces
    
    Args:
    count (float): Number of subdivisions
