...
const coreAtomicTools = {
  ...
  setVisibility: {
    description: "Set visibility state for an object",
    parameters: z.object({
      id: z.string().describe("Object identifier"),
      ...
      recursive: z
        .boolean()
        .default(false)
        .describe("Whether to apply to children"),
    }),
    returns: OperationResponse,
  },

  batchSetVisibility: {
    description: "Set visibility for multiple objects",
    parameters: z.object({
      items: z
        .array(
          z.object({
        ...
        .describe("Visibility settings to apply"),
      recursive: z
        .boolean()
        .default(false)
        .describe("Whether to apply to children"),
  ...
  // Lock Operations
  setLocked: {
    description: "Set lock state for an object",
    parameters: z.object({
      id: z.string().describe("Object identifier"),
      locked: z.boolean().describe("Lock state"),
      recursive: z
        .boolean()
        .default(false)
        .describe("Whether to apply to children"),
  ...
  batchSetLocked: {
    description: "Set lock state for multiple objects",
    parameters: z.object({
      items: z
        .array(
          z.object({
        ...
        .describe("Lock settings to apply"),
      recursive: z
        .boolean()
        .default(false)
        .describe("Whether to apply to children"),
